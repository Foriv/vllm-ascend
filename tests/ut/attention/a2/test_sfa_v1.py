...
class TestAscendSFAKPathFusion(TestBase):
    """K-path fusions: per-step int64 slot conversion.

    Note: the indexer GEMM-reuse tests from the upstream PR are not ported —
    this base's indexer.py predates the wk_weights_proj/forward_k structure
    they target.
    """
